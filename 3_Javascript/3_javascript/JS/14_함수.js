...
function print1(num,str) {//함수 선성 
    // 함수 정의
    console.log(`${num}은/는 ${str}입니다.`);
}

/* #btn 클릭 시 #input1의 값을 읽어와 print1() 함수 호출 */
...
// #btn2a 클릭 되었을 때 arratTest() 함수 호출 
...
document.querySelector("#btn2c").addEventListener("click", function(e){
