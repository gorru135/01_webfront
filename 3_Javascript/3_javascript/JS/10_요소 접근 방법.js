...
function nameTest(){
    ...
    for(let i =0; i <hobbyList.length; i++) {//순차 접근
        ...
        // input요소.checked -> 요소가 체크되어 있으면 true, 아님false
...
function cssTest(){
    /**
     * [요소 1개]
     * 1) document.quertSelector("CSS 선택자");
     *      ->선택자가 선택한 요소 중 첫번째 요소를 반환
     * [요소n개 -> 배열]
     * 2)documenet.querySelectorAll("CSS 선잭자");
