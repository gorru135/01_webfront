...
// 아이디가 test1-1인 요소를 얻어와 testa 변수에 저장 
const testa = document.querySelector("#test1-1");
...
testa.onclick = function(){
    alert("고전이벤트 모델 확인 버튼 클릭 됨");
}

// 고전 이벤트 모델 제거 

// #test1-2 버튼 클릭 시 
// #test1-1의 onclick 이벤트 리스너의 핸들러 제거하기 
