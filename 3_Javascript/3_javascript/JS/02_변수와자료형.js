...
console.log("menu :" + menu);
// 변수명이 중복되어 덮어쓰기 되면 
// 이전에 선언 해 놓은 변수를 쓸 수 없게 되는 문제가 발생 
...
console.log(foo);
//console.log(bar); //ReferenceError: bar is not defined [지역 변수라 {}외에서는 사용할수 없다]
